"""
Model Training Module for Classification Problem
...
class ModelTrainer:
    ...
    def split_data(self):
        ...
        self.X_train_val, self.X_test, self.y_train_val, self.y_test = train_test_split(
            ...
            stratify=self.y if hasattr(self.y, 'value_counts') else None
        )
        ...
        self.X_train, self.X_val, self.y_train, self.y_val = train_test_split(
            ...
            random_state=self.random_state,
            stratify=self.y_train_val if hasattr(self.y_train_val, 'value_counts') else None
        )
    ...
    def _optuna_tune(self, model_name, param_grid, n_trials=50, cv=5):
        ...
        if model_name == 'Random Forest':
            best_model = RandomForestClassifier(**best_params, random_state=self.random_state, n_jobs=-1)
        elif model_name == 'XGBoost':
    ...
    def save_best_model(self, filename='best_classification_model.pkl'):
