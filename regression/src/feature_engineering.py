"""
Feature Engineering Module for Regression Problem
...
class FeatureEngineer:
    ...
    def select_features(self, X, y, method='mutual_info', k=10):
        ...
        y : pd.Series or np.array
            Target variable
        method : str
            Feature selection method ('mutual_info', 'f_regression', 'correlation')
        k : int
        ...
        if method == 'mutual_info':
            ...
            selector = SelectKBest(score_func=r_regression, k=min(k, X.shape[1]))
        else:
