"""
Convenience script to run the regression pipeline with Flight Delays dataset.
...
def main():
    ...
    """
    print("="*70)
    print("FLIGHT DELAYS REGRESSION - AUTOMATED PIPELINE")
    print("="*70)
    ...
    print("  - Target column name (e.g., 'ARRIVAL_DELAY' or 'DEPARTURE_DELAY')")
    ...
    print("="*70)
    print("\nNext steps:")
    print("1. Review results in: regression/results/")
